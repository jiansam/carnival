...
<head>
    ...
    <link rel="shortcut icon" href="/carnival/public/img/favicon.ico" type="img/favicon.ico" />
    <!-- Layout -->
...
<body>
    <div id="app">
        <header>
            ...
            <!-- 可兌換 class="default"; 已兌換 class="disabled" -->
        ...
        <main>
            <img src="/carnival/public/img/programme.jpg" alt="">
        </main>
